...
`ohada-lib` supporte nativement la localisation des libellés de journal, garantissant que vos enregistrements correspondent à la langue de vos utilisateurs.
